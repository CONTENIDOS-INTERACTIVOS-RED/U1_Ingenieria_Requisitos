        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad “Identificación de requisitos”, aborda la importancia de recolectar, analizar y documentar necesidades de usuarios y stakeholders, en el desarrollo de software. Se estudian técnicas como entrevistas, encuestas, observación directa, talleres colaborativos y métodos ágiles, destacando su aplicación práctica. También se enfatiza el análisis de necesidades para traducirlas en requisitos claros y útiles. La unidad busca que el estudiante adquiera habilidades para interpretar demandas, estructurar entrevistas y priorizar información. Su correcta aplicación previene errores tempranos y garantiza la alineación entre expectativas del cliente y funcionalidades del sistema.
